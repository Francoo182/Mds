...
from utils import generar_pdf_informe_ingresos,generar_pdf_informe_servicios
...
def generar_pdf_informe_ingresos(fecha_inicio: str, fecha_fin: str):
    ...
    nombre_archivo_pdf = generar_pdf_informe_ingresos(datos)
