...
class ProfesionalPage:
    def __init__(self, root):
        ...
        self.btn_ver_citas_totales = tk.Button(self.side_menu, text="Ver Citas Totales", font=("Arial", 16), 
        ...
        self.btn_generar_reportes = tk.Button(self.side_menu, text="Generar Reportes", font=("Arial", 16), 
                                               bg="pink", fg="black", bd=0, cursor="hand2", 
        ...
        self.btn_listado_clientes_profesional = tk.Button(self.side_menu, text="Atras", font=("Arial", 16), 
                                                          bg="pink", fg="black", bd=0, cursor="hand2", 
                                                          command=self.atras)
        self.btn_listado_clientes_profesional.place(x=20, y=240, width=200, height=40)
